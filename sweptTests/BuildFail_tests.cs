...
namespace swept.Tests
{
    ...
    public class BuildFail_tests
    {
        ...
        {
            var change = new Change() { ID = "191", Description = "Major problem!", BuildFail = BuildFailMode.Any };
            var change2 = new Change() { ID = "200", Description = "Major problem!", BuildFail = BuildFailMode.Any };
