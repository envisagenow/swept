...
// $ANTLR 3.3.1.7705 ..\\..\\DSL\\ChangeRule.g 2013-12-31 09:32:28
...
public partial class ChangeRuleLexer : Antlr.Runtime.Lexer
{
	...
	private void mSTRING_LITERAL()
	{
		...
		try
		{
			...
			// ..\\..\\DSL\\ChangeRule.g:70:5: ( '\"' STRING_BODY_DQ '\"' | '/' STRING_BODY_RQ '/' | '\\'' STRING_BODY_SQ '\\'' )
			int alt9=3;
			...
			case 1:
				DebugEnterAlt(1);
				// ..\\..\\DSL\\ChangeRule.g:70:8: '\"' STRING_BODY_DQ '\"'
				{
				DebugLocation(70, 8);
				Match('\"'); 
				DebugLocation(70, 12);
			...
			case 2:
				DebugEnterAlt(2);
				// ..\\..\\DSL\\ChangeRule.g:71:8: '/' STRING_BODY_RQ '/'
				{
				DebugLocation(71, 8);
				Match('/'); 
				DebugLocation(71, 12);
			...
			case 3:
				DebugEnterAlt(3);
				// ..\\..\\DSL\\ChangeRule.g:72:8: '\\'' STRING_BODY_SQ '\\''
				{
				DebugLocation(72, 8);
				Match('\''); 
				DebugLocation(72, 13);
	...
	private void mSTRING_BODY_DQ()
	{
		...
		try
		{
			// ..\\..\\DSL\\ChangeRule.g:76:5: ( ( '\\\\\"' |~ ( '\"' ) )* )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:76:8: ( '\\\\\"' |~ ( '\"' ) )*
			{
			DebugLocation(76, 8);
			// ..\\..\\DSL\\ChangeRule.g:76:8: ( '\\\\\"' |~ ( '\"' ) )*
	...
	private void mSTRING_BODY_RQ()
	{
		...
		try
		{
			// ..\\..\\DSL\\ChangeRule.g:80:5: ( ( '\\\\/' |~ ( '/' ) )* )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:80:8: ( '\\\\/' |~ ( '/' ) )*
			{
			DebugLocation(80, 8);
			// ..\\..\\DSL\\ChangeRule.g:80:8: ( '\\\\/' |~ ( '/' ) )*
	...
	private void mSTRING_BODY_SQ()
	{
		...
		try
		{
			// ..\\..\\DSL\\ChangeRule.g:84:5: ( ( '\\\\\\'' |~ ( '\\'' ) )* )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:84:8: ( '\\\\\\'' |~ ( '\\'' ) )*
			{
			DebugLocation(84, 8);
			// ..\\..\\DSL\\ChangeRule.g:84:8: ( '\\\\\\'' |~ ( '\\'' ) )*
	...
	private void mREGEX_MODIFIERS()
	{
		...
		try
		{
			// ..\\..\\DSL\\ChangeRule.g:88:2: ( ( 'i' | 's' | 'w' )+ )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:88:4: ( 'i' | 's' | 'w' )+
			{
			DebugLocation(88, 4);
			// ..\\..\\DSL\\ChangeRule.g:88:4: ( 'i' | 's' | 'w' )+
			int cnt13=0;
	...
	private void mBARE_WORD()
	{
		...
		try
		{
			int _type = BARE_WORD;
			int _channel = DefaultTokenChannel;
			// ..\\..\\DSL\\ChangeRule.g:92:2: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:92:5: ( 'a' .. 'z' | 'A' .. 'Z' )+
			{
			DebugLocation(92, 5);
			// ..\\..\\DSL\\ChangeRule.g:92:5: ( 'a' .. 'z' | 'A' .. 'Z' )+
			int cnt14=0;
	...
	private void mEscapeSequence()
	{
		...
		try
		{
			// ..\\..\\DSL\\ChangeRule.g:100:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\\' ) )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:100:9: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\\' )
			{
			DebugLocation(100, 9);
			Match('\\'); 
	...
	private void mWS()
	{
		...
		try
		{
			int _type = WS;
			int _channel = DefaultTokenChannel;
			// ..\\..\\DSL\\ChangeRule.g:102:5: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:102:8: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
			DebugLocation(102, 8);
	...
	private void mLINE_COMMENT()
	{
		...
		try
		{
			...
			int _channel = DefaultTokenChannel;
			// ..\\..\\DSL\\ChangeRule.g:106:5: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
			DebugEnterAlt(1);
			// ..\\..\\DSL\\ChangeRule.g:106:7: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
			{
			DebugLocation(106, 7);
			Match("//"); 

			DebugLocation(106, 12);
			// ..\\..\\DSL\\ChangeRule.g:106:12: (~ ( '\\n' | '\\r' ) )*
